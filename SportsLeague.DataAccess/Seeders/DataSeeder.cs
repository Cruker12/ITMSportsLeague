...
public static class DataSeeder
{
    public static async Task SeedAsync(LeagueDbContext context)
    {
        ...
        var teams = new List<Team>
        {
            ...
            new() { Name="Atlético Bucaramanga", City="Bucaramanga", Stadium="Alfonso López", FoundedDate = new DateTime(1949, 6, 11) },
            new() { Name="Once Caldas", City="Manizales", Stadium="Palogrande", FoundedDate = new DateTime(1961, 10, 15) },
            new() { Name="Deportivo Pasto", City="Pasto", Stadium="Departamental Libertad", FoundedDate = new DateTime(1949, 5, 12) },
            new() { Name="Deportivo Pereira", City="Pereira", Stadium="Hernán Ramírez Villegas", FoundedDate = new DateTime(1944, 1, 12) },
            new() { Name="Águilas Doradas", City="Rionegro", Stadium="Alberto Grisales", FoundedDate = new DateTime(2008, 5, 20) },
            new() { Name="Boyacá Chicó FC", City="Tunja", Stadium="La Independencia", FoundedDate = new DateTime(2002, 10, 15) },
            new() { Name="Jaguares de Córdoba", City="Montería", Stadium="Jaraguay", FoundedDate = new DateTime(2012, 8, 17) },
            new() { Name="Alianza Valledupar FC", City="Valledupar", Stadium="Armando Maestre", FoundedDate = new DateTime(2003, 9, 1) },
            new() { Name="Fortaleza FC", City="Bogotá", Stadium="Metropolitano de Techo", FoundedDate = new DateTime(2010, 6, 14) },
            ...
            new() { Name="Internacional de Bogotá", City="Bogotá", Stadium="Metropolitano de Techo", FoundedDate = new DateTime(1960, 7, 5) },
        };
